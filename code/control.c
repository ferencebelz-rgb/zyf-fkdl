...
static void update_targets_from_camera(void)
{
    ...
    /* ===== task2 模式：检测 junction_side!=0，85° 出弯，T字路口序列 ===== */
    else
    {
        if (junction_side != 0)
        {
